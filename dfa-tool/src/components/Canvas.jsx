...
// import Node from "./FSM/Node";
// import Link from "./FSM/Link";
// import SelfLink from "./FSM/SelfLink";
// import StartLink from "./FSM/StartLink";
// import TemporaryLink from "./FSM/TemporaryLink";
...
function Canvas() {
  ...
  let caretTimer = useRef(null);

  // function resetCaret() {
  //   console.log("before " + caretTimer);
  //   clearInterval(caretTimer.current);
  //   console.log("after " + caretTimer);
  ...
  function resetCaret() {
    console.log("before " + caretTimer);
    caretTimer = clearInterval(caretTimer);

    console.log("after " + caretTimer);

    //working code i think
    caretTimer = setInterval((caretVisible = !caretVisible), draw(), 5000);
    // console.log(caretVisible);
    caretVisible = true;
  }
